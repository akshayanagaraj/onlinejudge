...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.code'
        db.alter_column(u'problems_submission', 'code', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Submission.code'
        db.alter_column(u'problems_submission', 'code', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
